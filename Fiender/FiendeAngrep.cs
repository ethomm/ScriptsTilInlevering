...
public class FiendeAngrep : MonoBehaviour
{
	...
	/*Denne Koden er flyttet til FiendeDetectionArea
	 * Årsaken er at Fienden har to Collidere, En for selve fiende som har Tagen Fiende og en Collider som er Området
	 * Den kan oppdage fiender som har taggen EnemyDetectionArea. Dette blir da to forskjellige områder med to forskjellige skripts knyttet
	 * til disse colliderne
	 * 
